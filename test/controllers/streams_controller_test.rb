...
class StreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post streams_url, params: { stream: { academic_type_id: @stream.academic_type_id, description: @stream.description, name: @stream.name } }
    end
  ...
  test "should update stream" do
    patch stream_url(@stream), params: { stream: { academic_type_id: @stream.academic_type_id, description: @stream.description, name: @stream.name } }
