...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { name: @year.name, stream_id: @year.stream_id, year: @year.year } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { name: @year.name, stream_id: @year.stream_id, year: @year.year } }
